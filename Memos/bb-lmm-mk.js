const DEFAULT_CONFIG={memos:"https://demo.usememos.com/",emactionApi:"https://emaction-go.mintimate.cn",limit:10,creatorId:"1",domId:"#bber"};function normalizeMemosUrl(e){if(typeof e!=="string"){return""}const t=e.trim();if(!t){return""}return t.endsWith("/")?t:`${t}/`}const bbMemo={...DEFAULT_CONFIG,...typeof bbMemos!=="undefined"?bbMemos:{}};bbMemo.memos=normalizeMemosUrl(bbMemo.memos);if(!bbMemo.memos||!bbMemo.domId){console.error("Memos配置不完整，请检查 memos 和 domId 参数")}function renderError(e){if(!AppState.bbDom){return}AppState.bbDom.innerHTML=`<div class="error">${e}</div>`}const Utils={loadCssCode(e){const t=document.createElement("style");t.type="text/css";t.rel="stylesheet";t.appendChild(document.createTextNode(e));document.head.appendChild(t)},getQueryVariable(t){const e=window.location.search.substring(1);const o=e.split("&");for(let e=0;e<o.length;e++){const r=o[e].split("=");if(r[0]===t){return decodeURIComponent(r[1])}}return false},async safeExecute(e,t="操作失败"){try{return await e()}catch(e){console.error(`${t}:`,e);throw e}}};const allCSS=`
/* 主容器 */
#bber {
  margin-top: 1rem;
